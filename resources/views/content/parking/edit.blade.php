...
<div class="container-fluid mb100">
    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="card">
                <div class="card-header">{{ __('Edit Parking') }}</div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group mb-1">
                                            ...
                                            <input id="vehicle_no" type="text"
                                                ...
                                                name="vehicle_no" value="{{ old('vehicle_no', $parking->vehicle_no) }}" autocomplete="off"
                                                required>
                                            ...
                                            <select name="category_id" id="category_id"
                                                ...
                                                <?php
                                                        foreach ($categories as $key => $value) {
                                                            echo '<option value="'.$value->id.'" '.((old('category_id', $parking->category_id) == $value->id) ? ' selected' : '').'>'.$value->type.'</option>';
                                                        }
                                                        ?>
                                            </select>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input id="driver_name" type="text"
                                            ...
                                            name="driver_name" value="{{ old('driver_name', $parking->driver_name) }}" autocomplete="off">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input id="driver_mobile" type="number"
                                                ...
                                                name="driver_mobile" value="{{ old('driver_mobile', $parking->driver_mobile) }}"
                                                autocomplete="off">
