                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('category.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="type" type="text" class="form-control {{ $errors->has('type') ? ' is-invalid' : '' }}" name="type" value="{{ old('type') }}" autocomplete="off" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                ...
                                <textarea name="description" id="description" cols="5" rows="5" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" required>{{ old('description') }}</textarea>
